...
document.addEventListener('DOMContentLoaded', function(){ // Solo espera que se descargue el HTML, no espera css ni imagenes
    console.log(4);
})

//Usualmente se usa este

function imprimir() { //Load espera a que el JS y los archivos que dependen del HTML esten listo
    console.log(2);
}
